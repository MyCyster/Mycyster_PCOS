...
export const CurrentDayMealPlanner = () => {
  return (
    <div className=" lg:block  mb-12 w-full">
      ...
      <button className="flex items-center justify-center gap-x-1"><FaRegEdit size={16} fill='#000000'/><span className="font-semibold text-lg text-[#000000]">Edit</span></button>
      </div>
