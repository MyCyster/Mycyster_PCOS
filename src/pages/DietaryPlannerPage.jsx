...
import { MealCard, ModalMealCard } from "../components/dashboard/MealCard";
...
import { DietaryPlannerForm } from "../components/DietaryPlanner/DietaryPlannerForm"
import { dietaryUrls } from "../components/DietaryPlanner/DietaryService"
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        if (response.data.mealPlans) {
          // transformedData = await response.data.map((item, i) => {
